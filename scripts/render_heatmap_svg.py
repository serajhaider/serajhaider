...
def main():
 ...
 svg=f'''<svg xmlns="http://www.w3.org/2000/svg" width="{width}" height="135" viewBox="0 0 {width} 135"><rect width="100%" height="100%" rx="14" fill="#0f172a" stroke="#2563eb"/><g transform="translate(8,10)">{''.join(cells)}</g><style>.l0{{fill:#1e293b}}.l1{{fill:#1e3a5f}}.l2{{fill:#2563eb}}.l3{{fill:#3b82f6}}.l4{{fill:#7dd3fc}}</style></svg>'''
